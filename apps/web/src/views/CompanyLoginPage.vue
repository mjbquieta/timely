  ...
  >
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <div class="text-center">
        ...
        <h2 class="text-3xl font-bold text-gray-900 mb-2">Company Portal</h2>
        <p class="text-sm text-gray-600">Sign in to your company account</p>
      </div>
    </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                class="appearance-none block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-palette-dark-blue focus:border-palette-dark-blue transition-colors"
                :class="{
                  'border-red-300 focus:ring-red-500 focus:border-red-500': errors.companyName,
                }"
...
const validateForm = () => {
  ...
  return !errors.username && !errors.password && !errors.companyName
}
...
const handleLogin = async () => {
  ...
  try {
    ...
    await authStore.companyLogin(form.username, form.password, form.companyName)

    // Redirect to company dashboard on successful login
